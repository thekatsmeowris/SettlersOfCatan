...
public class HexEdge extends Line {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(startPoint, hE.startPoint) && Objects.equals(endPoint, hE.endPoint)
				|| Objects.equals(startPoint, hE.endPoint) && Objects.equals(endPoint, hE.startPoint);
	}

	@Override
	public String toString() {
		return "HexEdge{" + "startPoint=" + startPoint + ", endPoint=" + endPoint + ", asset=" + asset + ", owned="
				+ owned + ", owner=" + owner + '}';
	}
