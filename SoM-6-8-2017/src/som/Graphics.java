...
public class Graphics {
    ...
    public Graphics() {
        ...
        //GraphicsContext gc = canvas.getGraphicsContext2D();
        marsImage = new Image(getClass().getResourceAsStream("graphics/mars.png"));
        spaceImage = new Image(getClass().getResourceAsStream("graphics/mars-background.png"));
        marsView = new ImageView(marsImage);

        spaceView = new ImageView(spaceImage);
        marsView.setRotate(270);
        spaceView.setRotate(270);
        marsView.setTranslateY(15);
        marsView.setTranslateX(-400);
        spaceView.setTranslateY(-3);//(20)
        spaceView.setTranslateX(-99);//(-270)
        spaceView.setFitHeight(710);
        spaceView.setFitWidth(953);
