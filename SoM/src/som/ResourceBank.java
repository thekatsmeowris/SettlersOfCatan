...
/**
 *
 * @author Chadwick J Davis CS 56 April-9-2017 Purpose: ResourceBank class and
 * Resource class for Settlers Of Mars Project. Contains an arrayList of
 * Resource objects and a simple driver to test the code.
 */
import java.util.*;
