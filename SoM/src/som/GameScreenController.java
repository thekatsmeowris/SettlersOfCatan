    ...
    private boolean offerTrade(TradePack tp) {
        ...
        if (tp.getReceiver()==thisPlayer){
            ...
            for (Node n: hbIncomingResources.getChildren()){
                ((Circle)((StackPane) n).getChildren().get(0)).setFill((board.getColorPalette())[((ObservableList)(hbIncomingResources.getChildren())).indexOf(n)]);
            ...
            for (Node n: hbOutgoingResources.getChildren()){
                ((Circle)((StackPane) n).getChildren().get(0)).setFill((board.getColorPalette())[((ObservableList)(hbOutgoingResources.getChildren())).indexOf(n)]);
...
//board setup
    ...
    public void buyRoadInPanel(ActionEvent e) throws IOException{
        System.out.println("You clicked me");
        closeBuild();
        System.out.println("You Closed Build successfully");
    ...
    public void buyCityInPanel(){
      System.out.println("You clicked me");
      closeBuild();
      System.out.println("You closed Build Panel successfully");
      System.out.println("BUILD CITY DIALOG");
        if(canBuildCity((HexVertex) selectedItem)){
            System.out.println("BUILD SETTLEMENT DIALOG");
           resourceBank.bankReturnResource(thisPlayer.removeResources(resourceBank.getResourceCost(((HexVertex)selectedItem).addCity(thisPlayer))));         //remove resources from a player and give them to the bank
    ...
    public void buySettlementInPanel(){
      System.out.println("You clicked me");
      closeBuild();
      System.out.println("You closed Build Panel successfully");
        if(canBuildSettlement((HexVertex) selectedItem)){
